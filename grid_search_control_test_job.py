...
directory = Path(str(Path.home()), 'test_data/')
parameter_dictionary = {
    'data_directory': directory,
    'run_index': 1,
    'num_nodes': 60,
    'edge_conservation_range': '0_1.05_0.2',  # work with me here. (args to np.arange separated by _)
    'selectivity_range': '0_1.05_0.2'
}
search_wide_dic = {
...
ensemble_params = {
    ...
    'num_runs': 60,  # num runs, could be cut off if reaches equilibrium condition first
