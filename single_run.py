...
if __name__ == '__main__':
    ...
    G.run(num_runs, exp_decay_param=12, constant_source_node=False, num_shifts_of_source_node=False, equilibrium_distance=200, seeding_sigma_coeff=False, seeding_power_law_exponent=10, beta=None, multiple_path=False)
