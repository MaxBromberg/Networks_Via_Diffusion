...
G.simulate(1000, eff_dist_delta_param=12, constant_source_node=False, num_shifts_of_source_node=False, seeding_sigma_coeff=False, seeding_power_law_exponent=5, beta=None, equilibrium_distance=200, multiple_path=False, verbose=True)
# G.run(num_runs, eff_dist_delta_param=12, constant_source_node=2, num_shifts_of_source_node=False, seeding_sigma_coeff=False, seeding_power_law_exponent=False, equilibrium_distance=200, multiple_path=False, verbose=True)
