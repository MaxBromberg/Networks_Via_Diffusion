...
source_reward, run_index = [int(arg) for arg in sys.argv[2:4]]  # eliminates name of file as initial input string
...
if __name__ == '__main__':
    ...
    G.simulate(num_runs=num_runs, eff_dist_delta_param=parameter, constant_source_node=constant_source_node, source_reward=source_reward, num_shifts_of_source_node=num_shifts_of_source_node,
