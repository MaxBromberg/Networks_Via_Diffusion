...
# G.scale_free_edge_init(degree_exponent=1.2, connected=True)
G.simulate(num_runs=num_runs, eff_dist_delta_param=10, constant_source_node=False, seeding_power_law_exponent=9, equilibrium_distance=200, multiple_path=False, verbose=True)
# G.simulate(num_runs=num_runs, eff_dist_delta_param=10, constant_source_node=4, seeding_power_law_exponent=False, equilibrium_distance=200, multiple_path=False, verbose=True)
plotter.plot_hierarchy_evolution(G, 10, morphospace_limits=False)

# plotter.plot_single_network(G, timestep=-1, show=True, node_size_scaling=10, source_weighting=True)
...
# plotter.plot_single_network(G, timestep=-1, show=True, node_size_scaling=20, source_weighting=True)
